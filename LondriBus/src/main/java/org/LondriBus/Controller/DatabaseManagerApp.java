...
public class DatabaseManagerApp {
    ...
    private static final String DB_URL = "jdbc:postgresql://189.90.66.154:5432/marcotab?currentSchema=londribus";
    private static final String DB_USER = "marcotab";
    private static final String DB_PASSWORD = "dbmarco2119";
